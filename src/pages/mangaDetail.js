	...
	if (details) {
		...
		return (
			<section className="text-gray-400 bg-gray-900 body-font overflow-hidden">
					...
					<div className="lg:w-4/5 mx-auto flex flex-wrap">
						<div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
							...
							<div className="flex border-t border-gray-800 py-2">
								...
								<span className="ml-auto text-white">{chapters}</span>
							</div>
							<div className="flex border-t border-gray-800 py-2">
								<span className="text-gray-500">Volumes:</span>
								<span className="ml-auto text-white">{volumes}</span>
							</div>
							<div className="flex border-t border-gray-800 py-2">
								<span className="text-gray-500">Status:</span>
								<span className="ml-auto text-white">{status}</span>
							</div>
				...
				<Characters id={id} type={"manga"} parameter={"characters"} />
			</section>
		);
	} else {
		return <Loading />;
